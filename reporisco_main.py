...
if show_senha ==1:
    ...
    if opcao =="Produto":
        ...
        if pressed:
            right_column.write(get_table_download_link(produto_filtro_produto), unsafe_allow_html=True)
        ...
        pressed = left_column.button('Baixar csv c/filtro ')
        if pressed:
            right_column.write(get_table_download_link(produto_filtro_dealo), unsafe_allow_html=True)
        ...
        pressed = left_column.button('Baixar csv c/filtro ')
        if pressed:
            right_column.write(get_table_download_link(produto_filtro_risco), unsafe_allow_html=True)
    else:
        ...
        pressed = left_column.button('Baixar csv c/filtro ')
        if pressed:
            right_column.write(get_table_download_link(produto_filtro), unsafe_allow_html=True)
